...
# ============================================================
# The Geometric Neuron (V4.1 Logic)
# ============================================================
class GeometricNeuronV4_UI:
    def __init__(self, initial_length=120, rc_alpha=0.92, initial_hz=10.0, dt=0.01):
        self.dt = dt
        self.rc_alpha = rc_alpha  # Higher = less attenuation (better wave travel)
        ...
        # Tight biological integration
        self.membrane_potential = 0.0
        self.membrane_leak = 0.88
        self.charge_rate = 0.12
        self.threshold = 0.48   # Selective but not impossible
        
        # Homeostasis (slow plasticity)
        self.chronic_activity = 0.1
        self.target_activity = 0.12
        self.plasticity_rate = 0.008   # Slower, more biological
        self.hunt_direction = -1

    def _grow_ais_grating(self, target_freq, length):
        """Burn in the physical AIS grating"""
    ...
    def adapt_morphology(self):
        """Only hunt if truly starving for a while"""
        if self.chronic_activity < self.target_activity * 0.4:
    ...
    def process(self, x_t, apply_plasticity=True, noise_level=0.05):
        ...
        if self.membrane_potential > self.threshold:
            ...
            self.membrane_potential = 0.0
            self.cable *= 0.35
            self.chronic_activity += 0.08   # Strong positive feedback
...
# ============================================================
# The Tkinter + Matplotlib 3D UI
# ============================================================
class GeometricNeuronUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Geometric Neuron: Phase Space Torus (Unified)")
        self.root.geometry("1200x800")
        
        # Engine
        self.dt = 0.01
        self.t = 0.0
        # Initialize the refined V4.1 Neuron
    ...
    def _get_takens_embedding(self, array):
        """Folds 1D spatial array into 3D using dynamic quarter-wave delay."""
        ...
        # Compensate for physical cable decay dynamically
        decay_factor = self.gn.rc_alpha
    ...
    def _simulation_step(self):
        while self.running:
            ...
            # Update 3D Visuals
            x_g, y_g, z_g = self._get_takens_embedding(self.gn.ais_grating * 5)
